...
public class TabbedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employeeNameBox = (TextView)findViewById(R.id.employeeName);
        ...
        /*try {
            ...
            //String employeeName = jObj.getString("firstName");

            TextView employeeNameBox = (TextView) findViewById(R.id.employeeName);
            String testName = "Turd Ferguson";
            employeeNameBox.setText(testName);
